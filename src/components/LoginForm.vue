<template >
    <div class="tw-w-full tw-max-w-xl tw-p-6 tw-space-y-8 sm:tw-p-8 tw-bg-white tw-rounded-lg tw-shadow dark:tw-bg-gray-800">
        <form class="tw-mt-2 tw-space-y-6" 
            @submit.prevent="this.$store.dispatch('handelLogin',{
            ...
            <div class="tw-flex tw-items-center tw-justify-between">
                <button 
                type="submit" 
                class="tw-w-full tw-px-5 tw-py-3 tw-text-base tw-font-medium tw-text-center tw-text-white tw-bg-red-700 tw-rounded-lg hover:tw-bg-red-800 focus:tw-ring-4 focus:tw-ring-red-300 sm:tw-w-auto "
                >Login to cenima salam</button>
